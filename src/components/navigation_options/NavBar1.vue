...
>
    ...
    <a class="text-2xl font-bold text-green-600 dark:text-white" href="#">
        Company Name
    </a>

    <div class="lg:hidden">
        <button class="navbar-burger flex items-center text-green-600 dark:text-gray-100 p-1" id="navbar_burger">
    ...
    <div class="hidden lg:flex">
        ...
        <a href="https://example.com/about">
            <button class=" py-1.5 px-3 m-1 text-center bg-green-700 border rounded-md text-white  hover:bg-green-500 hover:text-gray-100 dark:text-gray-200 dark:bg-green-700 hidden lg:block">
                    Company Name
            </button>
        </a>
        ...
        <div>
            ...
            <a class=" py-1.5 px-3 m-1 text-center bg-gray-100 border border-gray-300 rounded-md text-black  hover:bg-gray-100 dark:text-gray-300 dark:bg-gray-700 hidden lg:inline-block "
                href="https://Company Name.com/login">
                Sign In
            </a>
        </div>
...
<div class="navbar-menu relative z-50 hidden">
  <div class="navbar-backdrop fixed inset-0 bg-gray-800 opacity-50">
    ...
    <div class="flex items-center mb-8">
        <a class="mr-auto text-2xl font-bold text-black text-green-600 :text-gray-100"
            href="https://Company Name.com/">
            Company Name
        </a>
        <button class="navbar-close">
                <svg class="h-6 w-6 text-gray-400 cursor-pointer r:text-gray-500"
                    xmlns="http://www.w3.org/2000/svg" fill="none" Box="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" ke-width="2" d="M6 18L18 6M6 6l12 12">
                    </path>
                </svg>
        </button>
    </div>
    <div class=" relative mx-auto text-gray-600">
      <input class="border-2 border-gray-300 bg-white h-10 px-5 pr-16 ded-lg text-sm focus:outline-none dark:placeholder-gray-200 :bg-gray-500 dark:border-gray-50" type="search" name="search" eholder="Search">
          <button type="submit" class="absolute right-0 top-0 mt-3 mr-4">
                  <svg class="text-gray-600 dark:text-gray-200 h-4 w-4 -current"
                      xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://w3.  org/1999/xlink" version="1.1"
                      x="0px" y="0px" viewBox="0 0 56.966 56.966"   e="enable-background:new 0 0 56.966 56.966;"
                      xml:space="preserve" width="512px" height="512px">
                          <path
                              d="M55.146,51.887L41.588,37.786c3.486-4.144,5.396-9.  358,5.396-14.786c0-12.682-10.318-23-23-23s-23,10.  318-23,23  s10.318,23,23,23c4.761,0,9.298-1.436,13.  177-4.162l13.661,14.208c0.571,0.593,1.339,0.92,2.  162,0.92  c0.779,0,1.518-0.297,2.079-0.837C56.255,  54.982,56.293,53.08,55.146,51.887z M23.984,6c9.374,  0,17,7.626,17,17s-7.626,17-17,17  s-17-7.  626-17-17S14.61,6,23.984,6z" />
                    </svg>
          ...
          <div class="mt-auto">
            <div class="pt-6">
                ...
                <a class="block py-1.5 px-3 m-1 text-center bg-green-700 border rounded-md text-white  hover:bg-green-500 hover:text-gray-100 dark:text-gray-200 dark:bg-green-700 px-4 py-3 mb-2 text-xs text-center text-white font-semibold bg-green-600 hover:bg-green-700  rounded-xl"
            ...
            <p class="my-4 text-xs text-center text-gray-400">
                <span>Company Name Copyright © 20XY</span>
            </p>
          </div>
      </div>
    </nav>
...
const themeToggleBtn_2 = document.getElementById('theme-toggle-2')
if (themeToggleBtn_2) {
