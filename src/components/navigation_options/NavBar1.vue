...
<template>
  ...
  >
    <a class="text-2xl font-bold text-green-600 dark:text-white" href="#"> Company Name </a>
    ...
    <div class="hidden lg:flex">
      ...
      <a href="https://example.com/about">
        <button
          class="py-1.5 px-3 m-1 text-center bg-green-700 border rounded-md text-white hover:bg-green-500 hover:text-gray-100 dark:text-gray-200 dark:bg-green-700 hidden lg:block"
        >
          Company Name
        </button>
      </a>
  ...
  >
    <div class="navbar-menu relative z-50 hidden">
      ...
      <div class="flex items-center mb-8">
        <a class="mr-auto text-2xl font-bold text-black text-green-600 :text-gray-100" href="https://Company Name.com/">
          Company Name
        </a>
        <button class="navbar-close">
          <svg
            class="h-6 w-6 text-gray-400 cursor-pointer r:text-gray-500"
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
            Box="0 0 24 24"
            stroke="currentColor"
          >
            <path stroke-linecap="round" stroke-linejoin="round" ke-width="2" d="M6 18L18 6M6 6l12 12"></path>
          </svg>
        </button>
      </div>
      <div class="relative mx-auto text-gray-600">
        <input
          class="border-2 border-gray-300 bg-white h-10 px-5 pr-16 ded-lg text-sm focus:outline-none dark:placeholder-gray-200 :bg-gray-500 dark:border-gray-50"
          type="search"
          name="search"
          eholder="Search"
        />
        <button type="submit" class="absolute right-0 top-0 mt-3 mr-4">
          <svg
            class="text-gray-600 dark:text-gray-200 h-4 w-4 -current"
            xmlns="http://www.w3.org/2000/svg"
            ...
            y="0px"
            viewBox="0 0 56.966 56.966"
            e="enable-background:new 0 0 56.966 56.966;"
            xml:space="preserve"
            width="512px"
            height="512px"
          >
      ...
      <div class="mt-auto">
        <div class="pt-6">
          ...
          <a
            class="block py-1.5 px-3 m-1 text-center bg-gray-100 border border-gray-300 rounded-md text-black hover:bg-gray-100 dark:text-gray-300 dark:bg-gray-700 px-4 py-3 mb-3 text-sm text-center font-semibold rounded-xl"
            href="/login"
          >
            Sign in
          </a>
          ...
          <a
            class="block py-1.5 px-3 m-1 text-center bg-green-700 border rounded-md text-white hover:bg-green-500 hover:text-gray-100 dark:text-gray-200 dark:bg-green-700 px-4 py-3 mb-2 text-xs text-center text-white font-semibold bg-green-600 hover:bg-green-700 rounded-xl"
